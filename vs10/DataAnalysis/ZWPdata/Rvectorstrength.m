...
%   at frequency Freq of the spike times in Spt. A complex valeus is
%   returned. Its magnitude is what is usually called the vector strength;
%   its angle is the phase of the spike timing.
%
